...
import math
from .schemas import ProjectModelInput, FinancingTranche
...
class Trace:
    ...
    sign: str = "Positive values are cash inflows or assets unless labelled as costs"
...
def calculate_model(inp: ProjectModelInput):
